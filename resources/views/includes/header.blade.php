        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-12 col-12"> 
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main" style="background-color: red;">
                        <ul class="navbar-nav ml-auto">
							...
							@else
							<li class="nav-item"><a href="{{url('/jobs')}}" class="nav-link">{{__('Profile')}}</a> </li>
							@endif

							<li class="nav-item {{ Request::url()}}"><a href="{{url('/companies')}}" class="nav-link">{{__('Services')}}</a> </li>
                            @foreach($show_in_top_menu as $top_menu) @php $cmsContent = App\CmsContent::getContentBySlug($top_menu->page_slug); @endphp
                            <li class="nav-item {{ Request::url() == route('cms', $top_menu->page_slug) ? 'active' : '' }}"><a href="{{ route('cms', $top_menu->page_slug) }}" class="nav-link">{{__('A propos') }}</a> </li>
                            @endforeach
                            ...
                            <li class="nav-item") ; ><a href="{{route('login')}}" class="nav-link login">{{__('Sign in')}}</a> </li>
